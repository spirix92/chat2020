                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (str.startsWith("/authok ")) {
                            ...
                            fileHistory = new File("history_[" + login + "].txt");
                            break;
                        }
                    ...
                    //вывод последних 100 сообщений в чат
                    try (BufferedReader inHistory = new BufferedReader(new FileReader(fileHistory))) {
                        List<String> cache = new ArrayList<>();
                        String sIn;
                        while ((sIn = inHistory.readLine()) != null) {
                            cache.add(sIn);
                    ...
                    try (BufferedWriter outHistory = new BufferedWriter(new FileWriter(fileHistory, true))) {
                        //цикл работы
//                        цикл для тестового заполнения файла
//                        for (int i = 0; i <= 200; i++) {
//                            outHistory.write(("test" + i + "\n"));
//                        }
                        while (true) {
                            String str = in.readUTF();
                            if (str.startsWith("/")) {
